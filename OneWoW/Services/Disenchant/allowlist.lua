...
-- Items that fail the Weapon/Armor/Profession class heuristic but are still
-- disenchantable (Molinari Standard disenchantable.lua specials).
ns.DisenchantAllowlist = {
